...
const controller = require("./kategoriDokumen.controller");
const validation = require("./kategoriDokumen.validation");
...
// Read is open to every authenticated role (RLS: kategori_dokumen_select_authenticated).
...
// Soft delete; blocked with 409 while any dokumen still references this
// kategori (see kategoriDokumen.service.js).
