...
const controller = require("./divisi.controller");
const validation = require("./divisi.validation");
...
// Read is open to every authenticated role (RLS: divisi_select_authenticated).
