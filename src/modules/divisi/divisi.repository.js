...
// Referential-integrity guard for delete: divisi has no DB-level FK CASCADE
// behavior to enforce here (soft delete never fires one anyway), so the
// check is done at the app layer instead.
const hasPegawai = async (divisiId) => {
